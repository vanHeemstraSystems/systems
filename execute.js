 ...
 */
console.log('systems execute - _proxies: ', _proxies);
// Logs: function () { return new Proxies(); }
          ...
          if (additionalArgument
            ...
            for (var i = 0; i < additionalArgument.system.length; i++) {
              ...
              if (Object.keys(resourceForUuid).length == 0) {
                ...
                console.log('systems execute - resourceForUuid: ',
                  resourceForUuid)
              };
              ...
              if (Object.keys(instructionsForInstructions).length == 0) {
                ...
                console.log('systems execute - instructionsForInstructions: ',
...
.then(function(arrayOfPromises) {
  ...
  .catch(function(error) {
    console.log('systems execute - all error: ', error)
  })
  .finally(function() {
